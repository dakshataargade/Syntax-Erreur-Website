    ...
    <div className={`${sidebarOpen ? "touch-none" : ""} w-full`}>
      ...
      >
        <div>
          ...
          >
            <motion.p
              className=" w-44 h-10 flex items-center justify-center sm:h-12 pt-1 mr-8 text-xl text-center uppercase border-[3.16px] border-white cursor-pointer lg:text-3xl lg:w-64 max-w-none text-white font-Kanit font-bold tracking-wide"
        ...
        {showMediaIcons ? (
          <img
            src="https://img.icons8.com/ios/28/ffffff/menu--v1.png"
            className="block w-6 mb-2 cursor-pointer lg:hidden"
