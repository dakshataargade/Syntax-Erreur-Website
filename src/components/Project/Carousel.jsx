...
import POS1 from "../../assets/projectImages/POS1.png";
import POS2 from "../../assets/projectImages/POS2.png";
import POS3 from "../../assets/projectImages/POS3.png";
import POS4 from "../../assets/projectImages/POS4.png";
  ...
  const items = [
    {
      ...
      title: "KODIAC LABS",
      description:
        "Our development team created a revolutionary website that seamlessly integerate discord bots with non fungible tokens(NFTS). The client Provided a visually-stunning design, and our team expertly utilized the react framework to bring it to life.",
      image: [
        `${Kodiac2}`,
        `${Kodiac1}`,
        `${Kodiac3}`,
    ...
    },
    {
      ...
      title: "Carbon Coins",
      description:
        "We developed the innovative Carbon Coins mobile app, utilizing flutter technology and utilizing firebase as its database, to efficiently track and reduce carbon emissions from vehicles.",
      image: [
        `${CarbonCoin1}`,
        `${CarbonCoin2}`,
        `${CarbonCoin3}`,
    ...
    },
    {
      ...
      title: "News App",
      description:
        "Our Flutter team at SyntaxErreur successfully developed a news app that instantly notifies users about breaking news. Stay informed with the latest news at your fingertips.",
    ...
    },
    {
      ...
      title: "POS",
      description:
        "A point of sale (POS) is where customers pay for goods or services. It can be in person or online, with receipts in print or electronic format. Cloud-based POS systems are popular.",
    ...
    },
    {
      ...
      title: "Yolo",
      description:
        "We at SyntaxErreur created a social media plus dating app aimed at 10k to 20k users utilizing  Flutter for user interface and application logic for app integrating it with Firebase services to manage backend functionalities. Combining social networking and dating to forge meaningful connections, setting new standards for modern relationships.",
              ...
              <div className="w-full xl:w-[56.125rem] h-[50.5rem] sm:h-[38rem] md:h-[35rem] bg-[rgba(43,43,43,0.26)] mx-auto rounded-[14px]  backdrop-blur-[10px]  flex flex-col-reverse sm:flex-row items-center justify-evenly sm:justify-between">
                ...
                <div className="relative flex flex-wrap items-start w-full gap-5 py-20 overflow-auto transition-all duration-1000 rounded-l-lg rounded-r-lg sm:rounded-l-none bg-black/75 justify-evenly sm:w-1/2 h-1/2 sm:h-full">
                  {item.image.map((image) => {
                    return (
                      <div className="flex items-center transition-all ease-in-out duration-1000  justify-center hover:w-[55%] sm:w-[35%] rounded-xl">
                        <motion.img
                          src={image}
                          alt=""
      ...
      <div className="absolute -bottom-24 sm:-right-7  lg:-right-10  sm:top-20 flex flex-row sm:flex-col items-center justify-center xl:gap-12 gap-10 pl-[6px] w-[62%] sm:px-2 md:px-0 md:w-[10%] lg:px-0 sm:w-[10%] lg:w-[4%]  xl:px-0 h-12 sm:h-96">
        ...
        >
          <img
            src={LeftArrowIcon}
            alt=""
            className="w-8 h-8 sm:w-9 lg:w-10 sm:h-16"
          />
        </button>
        <button
          className="text-[50px] sm:text-[70px]  lg:text-[100px] xl:text-[120px] h-20 2xl:h-32 2xl:text-[180px] font-extralight text-center flex items-center justify-center bg-none p-2  sm:p-0 opacity-60 hover:opacity-100 duration-150 focus:scale-110"
        ...
        >
          <img
            src={RightArrowIcon}
            alt=""
            className="w-8 h-8 sm:w-9 lg:w-10 sm:h-20"
          />
        </button>
      </div>
    </div>
